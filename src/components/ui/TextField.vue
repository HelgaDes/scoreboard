...
<template>
  <div class="tf" :data-block="block">
    ...
    <IconButtonSmall v-if="clearable && modelValue" icon="close" title="Clear" @click="onClear" />
  </div>
</template>
<style scoped>
.tf{display:flex;width:241px;height:32px;padding:0 6px 0 14px;align-items:center;gap:8px;border-radius:9px;background:var(--TonalContainer, rgba(10,14,20,.5));box-shadow:0 -.318px .636px rgba(255,255,255,.30) inset,0 -.318px .636px rgba(255,255,255,.25) inset,.636px .955px 2.545px rgba(0,0,0,.08) inset,.636px .955px 2.545px rgba(0,0,0,.10) inset}
